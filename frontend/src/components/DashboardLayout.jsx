...
const navConfig = {
  ...
  librarian: [
    { key: 0, label: "Browse Books", icon: Search },
    { key: 1, label: "Manage Books", icon: BookMarked },
    { key: 2, label: "Issue & Return", icon: ArrowLeftRight },
    { key: 3, label: "Transactions", icon: Receipt },
  ],
  student: [
