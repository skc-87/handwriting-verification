...
const HandwritingSamplesTable = ({ data, isLoading, API_BASE_URL, searchTerm }) => {
  ...
  return (
    <div className="mb-8 p-6 rounded-xl bg-white shadow-lg border border-transparent relative overflow-hidden group hover:shadow-xl transition-all duration-300">
        ...
        <DataTable
          ...
          emptyMessage={
            <div className="text-center py-12">
              ...
              <p className="text-lg text-gray-500">No handwriting samples found</p>
              {searchTerm && (
